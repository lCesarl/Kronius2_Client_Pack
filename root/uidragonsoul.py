...
class DragonSoulWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			self.refineButton = self.GetChild("DSRefine_Button")
			self.deckTab = []
		...
		self.refineButton.SetEvent(ui.__mem_func__(self.ClickRefineButton)) 
	...
	def __SendMoveItemPacket(self, srcSlotWindow, srcSlotPos, dstSlotWindow, dstSlotPos, srcItemCount):
		...
		net.SendItemMovePacket(srcSlotWindow , srcSlotPos, dstSlotWindow, dstSlotPos, long(srcItemCount))
