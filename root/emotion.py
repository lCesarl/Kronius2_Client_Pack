...
if EMOTION_VERSION == 2:
	...
	EMOTION_DICT = {
		...
		EMOTION_DANCE_6 :		{"name": localeInfo.EMOTION_DANCE_6, 	"command":"/dance7"},
	...
	if app.ENABLE_WOLFMAN:
		ANI_DICT[chr.MOTION_FRENCH_KISS_WITH_WOLFMAN] = "french_kiss_with_wolfman.msa"
		ANI_DICT[chr.MOTION_KISS_WITH_WOLFMAN] = "kiss_with_wolfman.msa"
		ANI_DICT[chr.MOTION_SLAP_HIT_WITH_WOLFMAN] = "slap_hit.msa"
		ANI_DICT[chr.MOTION_SLAP_HURT_WITH_WOLFMAN] = "slap_hurt.msa"
