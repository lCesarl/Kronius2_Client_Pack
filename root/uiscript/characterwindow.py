			...
			[
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":15, "text":uiScriptLocale.CHARACTER_SKILL, "all_align":"center" },
				...
				},
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":-5, "text":uiScriptLocale.CHARACTER_ACTION, "all_align":"center" },
					),
				},
				{
					"name" : "Quest_TitleBar",
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":-10, "text":uiScriptLocale.CHARACTER_QUEST, "all_align":"center" },
					),
				},
