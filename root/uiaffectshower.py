...
class AffectShower(ui.Window):
	...
	AFFECT_DATA_DICT =	{
			...
			chr.AFFECT_FIRE : (localeInfo.SKILL_FIRE, "d:/ymir work/ui/skill/sura/hwayeom" + END_STRING + ".sub",),
			chr.AFFECT_CHINA_FIREWORK : (localeInfo.SKILL_POWERFUL_STRIKE, "d:/ymir work/ui/skill/common/affect/powerfulstrike" + END_STRING + ".sub",),
			...
			chr.NEW_AFFECT_BATTLE_PASS : (localeInfo.TOOLTIP_BATTLE_PASS, "d:/ymir work/ui/game/battle_pass/affect_battle_pass_icon.tga"),
			chr.NEW_AFFECT_LEVEL_ITEM : (localeInfo.TOOLTIP_LEVEL_ITEM, "d:/ymir work/ui/game/level_item/affect_level_item.tga"),
			chr.NEW_AFFECT_HONOR_MEDAL : (localeInfo.TOOLTIP_HONOR_MEDAL, "d:/ymir work/ui/game/honor_medal/70004.tga"),
	...
	if app.ENABLE_WOLFMAN:
		AFFECT_DATA_DICT[chr.AFFECT_RED_POSSESSION] = ("Purpurwolfseele", "d:/ymir work/ui/skill/wolfman/red_possession_03.sub",)
		AFFECT_DATA_DICT[chr.AFFECT_BLUE_POSSESSION] = ("Indigowolfseele", "d:/ymir work/ui/skill/wolfman/blue_possession_03.sub",)
