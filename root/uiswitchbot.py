...
class SwitchbotItemTab(ui.ThinBoard):
	...
	def OverInItem(self, overSlotPos):
		...
		self.tooltipItem.AddItemData(itemVnum, metinSlot, attrSlot, 0, 0, 1)	# die 1 am Ende steht f�r hidePreview=1
...
class SwitchbotWindow(ui.BoardWithTitleBar):
	...
	def __LoadWindow(self):
		...
		self.alternativePanel = ui.ThinBoard()
		...
		self.alternativeTextLine.SetText(localeInfo.SWITCHBOT_ALTERNATES)
