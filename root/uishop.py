...
class ShopDialog(ui.ScriptWindow):
	...
	def AskBuyItem(self, slotPos):
		...
		for i in xrange(shop.SHOP_BUY_ITEM_COUNT):
			if shop.GetBuyWithItem(slotPos, i) > 0:
				shopBuyItemCount += shop.shopGetBuyWithItemCount(slotPos, i)
				itemBuyQuestionDialog.SetText(localeInfo.DO_YOU_BUY_WITH_ITEM % (itemName, shopBuyItemCount))
			else:
