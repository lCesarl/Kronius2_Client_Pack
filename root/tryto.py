...
class ToolTip(ui.ThinBoard):
	...
	CRAFT_ITEM_COLOR = 0xffFFB96D

	TYRANIS_TOOLTIP_COLOR = 0xff5FFFF3
	CHANGELOOK_ITEMNAME_COLOR = HIGH_PRICE_COLOR
		...
		if systemSetting.IsShowRenderTarget():
			try:
				if app.IsPressed(app.DIK_LALT):
					if not self.ModelPreviewBoard.IsShow():
						self.ModelPreviewBoard.Show()
				else:
					if self.ModelPreviewBoard.IsShow():
...
class ItemToolTip(ToolTip):
	...
	AFFECT_DICT = {
		...
		item.APPLY_ATTBONUS_EMPIRES : localeInfo.TOOLTIP_APPLY_ATTBONUS_EMPIRES,
		item.APPLY_RESIST_EMPIRES : localeInfo.TOOLTIP_APPLY_RESIST_EMPIRES,
		item.APPLY_ATTBONUS_RED : localeInfo.TOOLTIP_APPLY_ATTBONUS_RED,
		item.APPLY_RESIST_RED : localeInfo.TOOLTIP_APPLY_RESIST_RED,
		item.APPLY_ATTBONUS_YELLOW : localeInfo.TOOLTIP_APPLY_ATTBONUS_YELLOW,
		item.APPLY_RESIST_YELLOW : localeInfo.TOOLTIP_APPLY_RESIST_YELLOW,
		item.APPLY_ATTBONUS_BLUE : localeInfo.TOOLTIP_APPLY_ATTBONUS_BLUE,
		item.APPLY_RESIST_BLUE : localeInfo.TOOLTIP_APPLY_RESIST_BLUE,
		item.APPLY_ATTBONUS_MALE : localeInfo.TOOLTIP_APPLY_ATTBONUS_MALE,
		item.APPLY_RESIST_MALE : localeInfo.TOOLTIP_APPLY_RESIST_MALE,
		item.APPLY_ATTBONUS_WOMAN : localeInfo.TOOLTIP_APPLY_ATTBONUS_WOMAN,
		item.APPLY_RESIST_WOMAN : localeInfo.TOOLTIP_APPLY_RESIST_WOMAN,
		item.APPLY_ATTBONUS_MOB_RANK0 : localeInfo.TOOLTIP_APPLY_ATTBONUS_MOB_RANK0,
		item.APPLY_RESIST_MOB_RANK0 : localeInfo.TOOLTIP_APPLY_RESIST_MOB_RANK0,
		item.APPLY_ATTBONUS_MOB_RANK1 : localeInfo.TOOLTIP_APPLY_ATTBONUS_MOB_RANK1,
		item.APPLY_RESIST_MOB_RANK1 : localeInfo.TOOLTIP_APPLY_RESIST_MOB_RANK1,
		item.APPLY_ATTBONUS_MOB_RANK2 : localeInfo.TOOLTIP_APPLY_ATTBONUS_MOB_RANK2,
		item.APPLY_RESIST_MOB_RANK2 : localeInfo.TOOLTIP_APPLY_RESIST_MOB_RANK2,
		item.APPLY_ATTBONUS_MOB_RANK3 : localeInfo.TOOLTIP_APPLY_ATTBONUS_MOB_RANK3,
		item.APPLY_RESIST_MOB_RANK3 : localeInfo.TOOLTIP_APPLY_RESIST_MOB_RANK3,
		item.APPLY_ATTBONUS_MOB_RANK4 : localeInfo.TOOLTIP_APPLY_ATTBONUS_MOB_RANK4,
		item.APPLY_RESIST_MOB_RANK4 : localeInfo.TOOLTIP_APPLY_RESIST_MOB_RANK4,
		item.APPLY_ATTBONUS_MOB_RANK5 : localeInfo.TOOLTIP_APPLY_ATTBONUS_MOB_RANK5,
		item.APPLY_RESIST_MOB_RANK5 : localeInfo.TOOLTIP_APPLY_RESIST_MOB_RANK5,
		item.APPLY_ATTBONUS_STONE : localeInfo.TOOLTIP_APPLY_ATTBONUS_STONE,
		item.APPLY_PICKUP_RANGE : localeInfo.TOOLTIP_APPLY_PICKUP_RANGE,
		item.APPLY_LIFESTEAL : localeInfo.TOOLTIP_APPLY_LIFESTEAL,
		item.APPLY_ATTBONUS_WARRIOR_JOB_1 : localeInfo.TOOLTIP_APPLY_ATTBONUS_WARRIOR_JOB_1,
		item.APPLY_RESIST_WARRIOR_JOB_1 : localeInfo.TOOLTIP_APPLY_RESIST_WARRIOR_JOB_1,
		item.APPLY_ATTBONUS_WARRIOR_JOB_2 : localeInfo.TOOLTIP_APPLY_ATTBONUS_WARRIOR_JOB_2,
		item.APPLY_RESIST_WARRIOR_JOB_2 : localeInfo.TOOLTIP_APPLY_RESIST_WARRIOR_JOB_2,
		item.APPLY_ATTBONUS_SHAMAN_JOB_1 : localeInfo.TOOLTIP_APPLY_ATTBONUS_SHAMAN_JOB_1,
		item.APPLY_RESIST_SHAMAN_JOB_1 : localeInfo.TOOLTIP_APPLY_RESIST_SHAMAN_JOB_1,
		item.APPLY_ATTBONUS_SHAMAN_JOB_2 : localeInfo.TOOLTIP_APPLY_ATTBONUS_SHAMAN_JOB_2,
		item.APPLY_RESIST_SHAMAN_JOB_2 : localeInfo.TOOLTIP_APPLY_RESIST_SHAMAN_JOB_2,
		item.APPLY_ATTBONUS_SURA_JOB_1 : localeInfo.TOOLTIP_APPLY_ATTBONUS_SURA_JOB_1,
		item.APPLY_RESIST_SURA_JOB_1 : localeInfo.TOOLTIP_APPLY_RESIST_SURA_JOB_1,
		item.APPLY_ATTBONUS_SURA_JOB_2 : localeInfo.TOOLTIP_APPLY_ATTBONUS_SURA_JOB_2,
		item.APPLY_RESIST_SURA_JOB_2 : localeInfo.TOOLTIP_APPLY_RESIST_SURA_JOB_2,
		item.APPLY_ATTBONUS_ASSASIN_JOB_1 : localeInfo.TOOLTIP_APPLY_ATTBONUS_ASSASIN_JOB_1,
		item.APPLY_RESIST_ASSASIN_JOB_1 : localeInfo.TOOLTIP_APPLY_RESIST_ASSASIN_JOB_1,
		item.APPLY_ATTBONUS_ASSASIN_JOB_2 : localeInfo.TOOLTIP_APPLY_ATTBONUS_ASSASIN_JOB_2,
		item.APPLY_RESIST_ASSASIN_JOB_2 : localeInfo.TOOLTIP_APPLY_RESIST_ASSASIN_JOB_2,
	...
	def SetShopItem(self, slotIndex):
		...
		for i in xrange(shop.SHOP_BUY_ITEM_COUNT):
			if shop.GetBuyWithItem(slotIndex, i) > 0:
				if i != shop.SHOP_BUY_ITEM_COUNT - 1:
					self.AppendBuyWithItemTextLine(shop.GetBuyWithItem(slotIndex, i), shop.GetBuyWithItemCount(slotIndex, i), shop.GetBuyWithItemType(slotIndex), FALSE)
				else:
					self.AppendBuyWithItemTextLine(shop.GetBuyWithItem(slotIndex, i), shop.GetBuyWithItemCount(slotIndex, i), shop.GetBuyWithItemType(slotIndex), TRUE)
		
		if shop.GetBuyWithItem(slotIndex, 0) == 0 and not shop.GetPrice(slotIndex) > 0:
			self.AppendPrice(price)
		if shop.GetPrice(slotIndex) > 0:
			self.AppendPrice(shop.GetPrice(slotIndex))
	...
	def AddItemData(self, itemVnum, metinSlot, attrSlot = 0, flags = 0, unbindTime = 0, hidePreview = 0):
		self.itemVnum = itemVnum
		item.SelectItem(itemVnum)
		itemType = item.GetItemType()
		...
		if item.ITEM_TYPE_SHINING == itemType:
			...
			SlotInfo = [localeInfo.SHINING_WEAPON, localeInfo.SHINING_ARMOR, localeInfo.SHINING_SPECIAL]

			self.AppendTextLine(localeInfo.SHINING_EQUIP + " : [%s]" % SlotInfo[itemSubType],self.CHANGELOOK_ITEMNAME_COLOR )
			self.__AppendLimitInformation()

			if hidePreview == 0 and constInfo.DISABLE_MODEL_PREVIEW == 0 and systemSetting.IsShowRenderTarget():
				if itemSubType == item.SHINING_WEAPON:
					self.ShowPreviewEmoji()
					self.__ModelPreview(itemVnum, 5, player.GetRace())
				elif itemSubType == item.SHINING_ARMOR:
					self.ShowPreviewEmoji()
					self.__ModelPreview(itemVnum, 6, player.GetRace())
				elif itemSubType == item.SHINING_SPECIAL:
					self.ShowPreviewEmoji()
					self.__ModelPreview(itemVnum, 7, player.GetRace())
		...
		### Weapon ###
			...
			if hidePreview == 0 and constInfo.DISABLE_MODEL_PREVIEW == 0 and systemSetting.IsShowRenderTarget():
				...
				elif item.WEAPON_DAGGER == itemSubType or item.WEAPON_BOW == itemSubType: 
					if player.GetRace() == 5 or player.GetRace() == 1:
						self.ShowPreviewEmoji()
						self.__ModelPreview(itemVnum, 3, player.GetRace())
				elif item.WEAPON_TWO_HANDED == itemSubType: 
					if player.GetRace() == 0 or player.GetRace() == 4:
						self.ShowPreviewEmoji()
						self.__ModelPreview(itemVnum, 3, player.GetRace())
				elif item.WEAPON_BELL == itemSubType or item.WEAPON_FAN == itemSubType: 
		...
		### Armor ###
			...
			## Render Target
			if hidePreview == 0 and constInfo.DISABLE_MODEL_PREVIEW == 0 and systemSetting.IsShowRenderTarget():
				if item.ARMOR_BODY == itemSubType and self.__ItemGetRace() == player.GetRace():
					self.ShowPreviewEmoji()
		...
		elif item.ITEM_AMULET == itemType:
			self.__AppendLimitInformation()
			self.__AppendAffectInformation()
			self.__AppendAttributeInformation(attrSlot)
		...
		### Costumes ###
			...
			## Render Target COSTUME_WEAPON
			elif isCostumeWeapon:
				
				self.__AppendAffectInformation()
				self.__AppendAttributeInformation(attrSlot)
				self.AppendWearableInformation()
				iValue = item.GetValue(3)
				
				if hidePreview == 0 and constInfo.DISABLE_MODEL_PREVIEW == 0 and systemSetting.IsShowRenderTarget():
					if item.WEAPON_SWORD == iValue: 
						if player.GetRace() != 7 and player.GetRace() != 3:
							self.ShowPreviewEmoji()
							self.__ModelPreview(itemVnum, 3, player.GetRace())
					elif item.WEAPON_DAGGER == iValue or item.WEAPON_BOW == iValue:
						if player.GetRace() == 5 or player.GetRace() == 1:
							self.ShowPreviewEmoji()
							self.__ModelPreview(itemVnum, 3, player.GetRace())
					elif item.WEAPON_TWO_HANDED == iValue:
						if player.GetRace() == 0 or player.GetRace() == 4:
							self.ShowPreviewEmoji()
							self.__ModelPreview(itemVnum, 3, player.GetRace())
					elif item.WEAPON_BELL == iValue or item.WEAPON_FAN == iValue:
						if player.GetRace() == 7 or player.GetRace() == 3:
							self.ShowPreviewEmoji()
							self.__ModelPreview(itemVnum, 3, player.GetRace())
					
			## Render Target COSTUME_MOUNT
			elif isCostumeMount:
				self.__AppendAffectInformation()
				self.__AppendAttributeInformation(attrSlot)
				
				self.AppendTextLine("|Eemoji/key_ctrl|e + |Eemoji/key_g|e - rufen/aufsteigen", self.CONDITION_COLOR, FALSE)
				self.AppendTextLine("|Eemoji/key_ctrl|e + |Eemoji/key_b|e - weg schicken", self.CONDITION_COLOR, FALSE)
				if hidePreview == 0 and constInfo.DISABLE_MODEL_PREVIEW == 0 and systemSetting.IsShowRenderTarget():
					self.AppendTextLine("|Eemoji/key_alt|e - " + localeInfo.PREVIEW, self.CONDITION_COLOR, FALSE)
					self.__ModelPreview(itemVnum, 0, item.GetValue(0))
				
			## Render Target COSTUME_PET
			elif isCostumePet:
		...
		## item.ITEM_TYPE_BLEND
			...
			if app.ENABLE_NEW_BLEND:
				if itemSubType == item.INFINITY_BLEND:
					isActivated = int(metinSlot[2])
					blend_data = constInfo.load_blend()
					for blend in blend_data:
						if int(blend[0]) == itemVnum:
							attribute = self.__GetAffectString(int(blend[1]), int(blend[2][3]))
							if isActivated == 1:
								self.AppendTextLine(attribute, 0xff86e57f)
							else:
								self.AppendTextLine(attribute, 0xfff15f5f)
							break
					
					self.AppendTextLine(localeInfo.ITEM_PERMANENT, self.NORMAL_COLOR)
					self.AppendSpace(5)
					if isActivated == 1:
						self.AppendTextLine(localeInfo.BLEND_ITEM_TOOLTIP_APPLY, 0xff86e57f )
					else:
						self.AppendTextLine(localeInfo.BLEND_ITEM_TOOLTIP_UNAPPLIED, 0xfff15f5f )
				else:
					if metinSlot:
			...
			if 0 != metinSlot:
				...
				if 1 == bHasRealtimeFlag:
					...
					time = metinSlot[player.METIN_SOCKET_MAX_NUM-4]
		...
		### Use ###
			...
			if item.USE_SPECIAL == itemSubType:
				...
				## Open multiple Items
				if itemVnum == 71107 or itemVnum == 71111:
					self.AppendTextLine("|Eemoji/key_shift|e + |Eemoji/key_rclick|e - %s" % localeInfo.ITEM_MULTIPLE_OPEN_10, self.SPECIAL_POSITIVE_COLOR)
						

				elif itemVnum == itemVnum == 27987 or itemVnum == 80005 or itemVnum == 80006 or itemVnum == 80007:
					self.AppendTextLine("|Eemoji/key_shift|e + |Eemoji/key_rclick|e - %s" % localeInfo.ITEM_MULTIPLE_OPEN_50, self.SPECIAL_POSITIVE_COLOR)
			...
			self.__AppendAttributeInformation(attrSlot)
		elif app.ENABLE_SHOW_CHEST_DROP and item.ITEM_TYPE_GIFTBOX == itemType:
			self.__AppendLimitInformation()
			self.AppendTextLine("|Eemoji/key_shift|e + |Eemoji/key_rclick|e - %s" % localeInfo.CHEST_INSIGHT_CONTENT, self.SPECIAL_POSITIVE_COLOR) ## Open multiple Items
		else:
			self.__AppendLimitInformation()

		for i in xrange(item.LIMIT_MAX_NUM):
			(limitType, limitValue) = item.GetLimit(i)
			yourItemName = item.GetItemName()
			#dbg.TraceError("ItemName : %s, LimitType : %d, limitValue : %d" % (yourItemName, limitType, limitValue))
	...
	def AppendBuyWithItemTextLine(self, buyItem, buyItemCount, buyType, lastOne):
		item.SelectItem(buyItem)
		...
		textLine.SetFontName(self.defFontName)
		textLine.SetPackedFontColor(self.CRAFT_ITEM_COLOR)
		textLine.SetText("%sx" % (localeInfo.TOOLTIP_BUYPRICE % int(buyItemCount)))
		textLine.SetOutline()
		textLine.SetFeather(FALSE)
		...
		textLineName.SetPackedFontColor(self.CRAFT_ITEM_COLOR)
		...
		if buyType == 1 and not lastOne:
			textLineType = ui.TextLine()
			textLineType.SetParent(windowBack)
			textLineType.SetFontName(self.defFontName)
			textLineType.SetPackedFontColor(self.CRAFT_ITEM_COLOR)
			textLineType.SetText(localeInfo.SHOP_TEXT_OR)
			textLineType.SetOutline()
			textLineType.SetFeather(FALSE)
			textLineType.SetPosition(textLine.GetTextSize()[0] + itemImage.GetWidth() + textLineName.GetTextSize()[0] + 6, 10)
			textLineType.Show()
			
			windowBack.SetPosition(0, self.toolTipHeight)
			windowBack.SetSize(textLine.GetTextSize()[0] + itemImage.GetWidth() + textLineName.GetTextSize()[0] + textLineType.GetTextSize()[0] + 8, 32)
		...
		if buyType == 1 and not lastOne:
			self.childrenList.append(textLineType)
		self.childrenList.append(itemImage)
	...
	def __AppendHairIcon(self, itemVnum):
		...
		if self.__IsOldHair(itemVnum):
			...
			ImagePath = "d:/icon/hair/%d.sub" % (itemVnum)
	...
	def ShowPreviewEmoji(self):
		if systemSetting.IsShowRenderTarget():
			self.AppendTextLine("|Eemoji/key_alt|e - " + localeInfo.PREVIEW, self.CONDITION_COLOR)

	def __ModelPreview(self, Vnum, type, model):
	
		## uigameoption settings
		if not systemSetting.IsShowRenderTarget():
			return
		...
		self.ModelPreviewText.SetText(localeInfo.PREVIEW)
		...
		if type == 1:
			...
			#R�stungskost�m/Standardkost�m
			if (player.GetItemIndex(item.COSTUME_SLOT_BODY) > 0): #R�stungskost�m
				renderTarget.SetArmor(RENDER_TARGET_INDEX,  player.GetItemIndex(item.COSTUME_SLOT_BODY))
			elif (player.GetItemIndex(item.COSTUME_SLOT_BODY) < 1): #Standardr�ssi
				renderTarget.SetArmor(RENDER_TARGET_INDEX,  player.GetItemIndex(item.EQUIPMENT_BODY))
				
			#Waffenkost�m/Standardwaffe
			if (player.GetItemIndex(item.COSTUME_SLOT_WEAPON) > 0): #Waffenkost�m
