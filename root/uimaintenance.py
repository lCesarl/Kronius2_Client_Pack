import ui, wndMgr, time, app, locale, chat, constInfo, localeInfo, chat
...
def pTableTranslate(i):
	...
	translate = {
					1	:	pTextColor[0] + localeInfo.MAINTENANCE_IN + "           " + pTextColor[2] + "[%s]",
					2	:	pTextColor[1] + localeInfo.MAINTENANCE_TAKES + " 	                              			 	  " + pTextColor[3] + "[%s]",
					3	:	localeInfo.MAINTENANCE_REASON_DEFAULT,
					4	:	localeInfo.MAINTENANCE_REASON_CUSTOM + "%s",
					5	:	localeInfo.MAINTENANCE_DAYS,
					6	:	localeInfo.MAINTENANCE_HOURS,
					7	:	localeInfo.MAINTENANCE_MINUTES,	
				}
